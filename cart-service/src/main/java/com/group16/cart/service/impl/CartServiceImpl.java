package com.group16.cart.service.impl;
...
import com.group16.cart.mapper.CartMapper;
...
//        // 2.3 利用RestTemplate调用远程服务
//        ResponseEntity<List<ItemDTO>> response = restTemplate.exchange(
//                instance.getUri()+"/items?ids={ids}", // request url
//                HttpMethod.GET, // request method
//                null,   // request body
//                new ParameterizedTypeReference<List<ItemDTO>>() {
//                }, // response type
//                Map.of("ids", CollUtils.join(itemIds, ",")) // request params
//        );
//        if (!response.getStatusCode().is2xxSuccessful()) {
//            return;
//        }
//        List<ItemDTO> items = response.getBody();
        // Using Feign to call remote service
